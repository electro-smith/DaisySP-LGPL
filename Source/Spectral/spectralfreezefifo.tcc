...
void SpectralFreezeFifo<FFT_SIZE, OVERLAP, WINDOW_SIZE>::Init(SpectralBuffer<FFT_SIZE>& fsig_in, float freeze_amp, float freeze_freq, int sample_rate)
{
...
template <size_t FFT_SIZE, size_t OVERLAP, size_t WINDOW_SIZE>
SpectralBuffer<FFT_SIZE>& SpectralFreezeFifo<FFT_SIZE, OVERLAP, WINDOW_SIZE>::Process(SpectralBuffer<FFT_SIZE>& fsig_in)
{
    int     i;
    int     framesize;
    float   freeza, freezf;
